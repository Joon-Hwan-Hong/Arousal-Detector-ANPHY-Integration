...
flags = tf.app.flags
FLAGS = flags.FLAGS
flags.DEFINE_string('pathname', 'D:\\Project\\OUT', 'Files to execute.')
...
flags.DEFINE_string('output_dir','D:\\Project\\MAD_OUT', 'Directory for predictions')
flags.DEFINE_integer('overwrite',1, 'Overwrite previous predictions (1 = Overwrite)')
